...
A full report is in [examples/sample-friction-log.md](examples/sample-friction-log.md). The notes on Jev that shaped the design are in [docs/research.md](docs/research.md).

## Installation

Available on [PyPI](https://pypi.org/project/docfriction/):
...
Bug reports, rubric ideas and pull requests are welcome. [CONTRIBUTING.md](CONTRIBUTING.md) covers setup, the checks CI runs, and the rules for changing what we ask Jev. Security issues go through [SECURITY.md](SECURITY.md). Releases are listed in [CHANGELOG.md](CHANGELOG.md).
