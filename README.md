...
> [!IMPORTANT]
> This is **alpha** software. The rubric and thresholds haven't been checked against human-written friction logs yet, and the CLI may change before v1.0, so pin your version. Findings are a first pass for a writer to confirm, not a verdict on the page.
...
Requires Python 3.10+. `--dry-run` works without a key. From source:
